...
export default function PortalLoginPage() {
  ...
  const [email, setEmail] = useState("john@smithfamily.com.au");
      ...
      <div className="w-full max-w-[400px] rounded-2xl border border-brand-border bg-white p-8 shadow-[0_1px_3px_rgba(0,0,0,.08),0_4px_16px_rgba(0,0,0,.06)]">
        ...
        <div className="mb-4 rounded-brand-sm bg-brand-surface p-3">
          ...
          <button
            ...
            disabled={loading}
            onClick={() => {
              setEmail("john@smithfamily.com.au");
              setPassword("demo123");
            }}
            className="flex w-full cursor-pointer items-center justify-between rounded-md border border-brand-border bg-white px-2.5 py-2 text-left transition-colors hover:border-brand-orange-border"
          >
            <div>
        ...
        <Button className="w-full justify-center" disabled={loading} onClick={signIn}>
